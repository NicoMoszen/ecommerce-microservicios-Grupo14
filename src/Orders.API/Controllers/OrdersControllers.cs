...
public class OrdersController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ActiveOrdersCountResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<IActionResult> GetActiveCountByProduct([FromQuery] Guid productoId)
    {
        var cantidad = await _orderService.CountActiveByProductAsync(productoId);
        return Ok(new ActiveOrdersCountResponse { ProductoId = productoId, OrdenesActivas = cantidad });
    }
